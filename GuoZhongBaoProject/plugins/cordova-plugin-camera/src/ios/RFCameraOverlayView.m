...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    //添加辅助对齐图片
    self.overlayImage = [[OverLayerImageView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height - 150)];
    ...
    //底部控制条
    UIView *bottomBar = [[UIView alloc] initWithFrame:CGRectMake(0, frame.size.height - 98, frame.size.width, 100)];
    ...
    taskPicBtn.frame = CGRectMake((frame.size.width - 80) / 2, 10, 80, 80);
    ...
    leftBtn.frame = CGRectMake(20, 30, 80, 44);
